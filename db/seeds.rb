...
FactoryGirl.create :user_mike_jones
FactoryGirl.create :user_sally_smith
FactoryGirl.create :user_bob_poole
FactoryGirl.create :user_tim_jones
FactoryGirl.create :user_bill_smith


# taken from https://raw.github.com/jeffomatic/linkedin_industries/master/linkedin_industries.rb
[{"code"=>47, "groups"=>["corp", "fin"], "description"=>"Accounting"},
 ...
 {"code"=>103,
  "groups"=>["art", "med", "rec"],
  "description"=>"Writing and Editing"}].each do |industry|
